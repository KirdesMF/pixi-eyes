...
export const DEFAULT_REPULSION_VARIATION = 0.4; // 40% per-eye variation (more visible)
export const DEFAULT_REPULSION_WOBBLE = 3; // 3 lobes for obvious organic shape
export const DEFAULT_REPULSION_WOBBLE_AMOUNT = 0.25; // 25% distance wobble (more visible)
export const DEFAULT_REPULSION_MOVEMENT_INFLUENCE = 0.8; // 80% movement influence (more visible)
