...
export const DEFAULT_ROUND_GLOBE_HIGHLIGHT_SCALE = 0.58;
...
export const DEFAULT_ROUND_GLOBE_HIGHLIGHT_OPACITY = 0.9;
export const DEFAULT_ROUND_GLOBE_HIGHLIGHT_COLOR = 0xfffbf2;
