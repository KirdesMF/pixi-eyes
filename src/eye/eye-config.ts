...
export const DEFAULT_EDGE_IRIS_COLOR = 0xff6b6b; // Coral red for edge eyes
export const DEFAULT_EDGE_IRIS_WIDTH = 20; // Width of edge zone in pixels
export const DEFAULT_EDGE_IRIS_BLEND = 0.5; // Blend factor for smooth transition
