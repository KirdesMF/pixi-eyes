...
export const DEFAULT_REPULSION_VARIATION = 0.2; // 20% per-eye variation
export const DEFAULT_REPULSION_WOBBLE = 4; // Number of lobes in organic shape
export const DEFAULT_REPULSION_WOBBLE_AMOUNT = 0.15; // 15% distance wobble
export const DEFAULT_REPULSION_MOVEMENT_INFLUENCE = 0.5; // 50% movement influence
