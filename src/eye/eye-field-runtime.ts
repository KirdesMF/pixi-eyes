...
import {
  ...
  DEFAULT_SLIT_PUPIL_WIDTH,
  DEFAULT_SLIT_PUPIL_HEIGHT,
  DEFAULT_SLIT_GLOBE_BASE_COLOR,
  DEFAULT_SLIT_MOUSE_COLOR,
  DEFAULT_DOT_EYE_MIX,
...
export function createRuntime(count: number): EyeFieldRuntime {
  return {
    ...
    slitEyeMix: DEFAULT_SLIT_EYE_MIX,
    slitPupilWidth: DEFAULT_SLIT_PUPIL_WIDTH,
    slitPupilHeight: DEFAULT_SLIT_PUPIL_HEIGHT,
    ...
    slitGlobeBaseColor: DEFAULT_SLIT_GLOBE_BASE_COLOR,
    slitMouseColor: DEFAULT_SLIT_MOUSE_COLOR,
